...
import { STOCK_COMPANY_PROFILES } from "./companyReality.js";
...
export function createSeedMarket(): MarketState {
  return {
    ...
    assets: [
      ...
      stockAsset({ id: "hgrid", symbol: "HGRD", name: "Harvest Grid", kind: "stock", sector: "Energy", price: 31.75, baselineVolatility: 0.22, sentiment: -0.12, momentum: -0.08, sectorTrend: -0.05, companyStrength: 0.3 }),
